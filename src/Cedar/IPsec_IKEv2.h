...
IKEv2_CRYPTO_KEY_DATA* IKEv2GenerateKeymatForIKESA(
    IKEv2_CRYPTO_SETTING* setting, IKEv2_PRF* prf, BUF *nonce_i, BUF *nonce_r,UCHAR *shared_key, UINT key_len,
    UINT64 SPIi, UINT64 SPIr, void* sk_d, UINT len_sk_d, bool isInitial);

DH_CTX* Ikev2CreateDH_CTX(IKEv2_DH* dh);

IKEv2_ENCR* Ikev2CreateEncr(
    UCHAR type, bool is_fixed, UINT* key_sizes, UINT key_count, UINT min_key,
