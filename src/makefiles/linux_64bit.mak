...
OPTIONS_COMPILE_RELEASE=-DNDEBUG -DVPN_SPEED -DUNIX -DUNIX_LINUX -DCPU_64 -D_REENTRANT -DREENTRANT -D_THREAD_SAFE -D_THREADSAFE -DTHREAD_SAFE -DTHREADSAFE -D_FILE_OFFSET_BITS=64 -I./src/ -I./src/Cedar/ -I./src/Mayaqua/ -O2 -fsigned-char -m64 -g
...
tmp/objs/Cedar/IPsec_IKEv2.o: src/Cedar/IPsec_IKEv2.c $(HEADERS_MAYAQUA) $(HEADERS_CEDAR)
	$(CC) $(OPTIONS_COMPILE) -c src/Cedar/IPsec_IKEv2.c -o tmp/objs/Cedar/IPsec_IKEv2.o

tmp/objs/Cedar/IPsec_Ikev2Packet.o: src/Cedar/IPsec_Ikev2Packet.c $(HEADERS_MAYAQUA) $(HEADERS_CEDAR)
	$(CC) $(OPTIONS_COMPILE) -c src/Cedar/IPsec_Ikev2Packet.c -o tmp/objs/Cedar/IPsec_Ikev2Packet.o
...
clean:
	...
	-rm -rf debian/*.debhelper.log debian/*.substvars
